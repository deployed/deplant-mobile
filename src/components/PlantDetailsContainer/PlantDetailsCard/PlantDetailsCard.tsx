  ...
  return (
    <View style={tw`bg-white my-6 p-4 shadow-lg shadow-white rounded-lg`}>
      <View style={tw`flex-row justify-start`}>
        <Image style={tw`rounded-lg mr-20px`} source={imgSource} />
        <View style={tw`flex-col justify-start`}>
          <InfoDisplay title="Połozenie" wrapperStyles="mb-20px">
            {location}
          </InfoDisplay>
      ...
      <View style={tw`flex-row justify-center items-center my-5`}>
        <View style={tw`flex-row justify-between items-center`}>
          ...
          <Text style={tw`text-10px`}>Co</Text>
          <Text
            style={tw`text-14px font-semibold`}>{` ${waterInterval} `}</Text>
          <Text style={tw`text-10px w-90px`}>dni</Text>
        </View>
      ...
      <View>
        <InfoDisplay wrapperStyles="mb-2" title="Gatunek">
          {species}
        </InfoDisplay>
